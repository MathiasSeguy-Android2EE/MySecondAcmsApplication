 ...
 */
public class MySmsMessageDaoMock implements MySmsMessageDaoIntf{
    private static final String TAG = "MySmsMessageDao";
    /***********************************************************
    *  Constructors
    **********************************************************/
    private MySmsMessageDaoMock(){}
    public MySmsMessageDaoMock(MyApplication app){
        if(app==null){
     ...
     */
    public void loadAll(){
        ArrayList<MySmsMessage> mockList=new ArrayList<MySmsMessage>();
        mockList.add(new MySmsMessage("Go fuck I am late",0));

        EventBus.getDefault().post(new MySmsMessageLoadedEvent( mockList));
    }
