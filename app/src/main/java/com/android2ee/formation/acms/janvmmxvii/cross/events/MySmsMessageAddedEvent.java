 ...
 */
public class MySmsMessageAddedEvent {
    MySmsMessage addedMessage;

    public MySmsMessageAddedEvent(MySmsMessage addedMessage) {
        this.addedMessage = addedMessage;
    }

    public MySmsMessage getAddedMessage() {
        return addedMessage;
    }

    public void setAddedMessage(MySmsMessage addedMessage) {
        this.addedMessage = addedMessage;
    }
}
